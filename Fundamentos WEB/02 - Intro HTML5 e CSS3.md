...
<img src="https://github.com/gildoneto/dio-desafio-github/blob/main/img/01-elemento-HTML.png?raw=true" alt="Elemento HTML" width="400" />

### Estrutura Básica

```HTML
<!DOCTYPE html> <!-- Tipo de documento -->
<html>  <!-- Todo o documento -->
  <head> <!-- Meta informações -->
    <meta>  <!-- várias infos como charset -->
...
<img src="https://github.com/gildoneto/dio-desafio-github/blob/main/img/02-seletor-CSS.png?raw=true" alt="Seletor CSS" width="400" />
...
<img src="https://github.com/gildoneto/dio-desafio-github/blob/main/img/03-classe-id.png?raw=true" alt="Classe X Id" width="400" />
